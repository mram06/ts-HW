...
function defineDayOfWeek(day: Day | string): void {
...
const userDay: Day | string = prompt(
  "Введіть назву або номер дня (1-7), (sunday, monday, tuesday, wednesday, thursday, friday, saturday)"
)!;
